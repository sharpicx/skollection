...
class VitalityTheme : ThemeContainer154
{
    Color G1;
    Color G2;
...
class VitalityButton : ThemeControl154
{
    Color G1;
    Color G2;
...
class VitalityCheckbox : ThemeControl154
{
    Color BG;
...
[DefaultEvent("CheckedChanged")]
class VitalityRadiobutton : ThemeControl154
{
...
class VitalityProgressbar : ThemeControl154
{
    Color BG;
...
class VitalityTabControl : TabControl
{
