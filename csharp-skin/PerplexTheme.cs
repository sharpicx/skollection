...
namespace CS_ClassLibraryTester
{
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            switch (State)
            {
                ...
                case MouseState.Over:
                    lgb = new LinearGradientBrush(ClientRectangle, Color.FromArgb(66, 67, 70), Color.FromArgb(43, 44, 48), 90);
                    G.FillPath(lgb, Draw.RoundRect(ClientRectangle, 2));
                    gloss = new LinearGradientBrush(new Rectangle(0, 0, Width - 125, 35 / 2), Color.FromArgb(15, Color.FromArgb(26, 26, 26)), Color.FromArgb(1, 255, 255, 255), 90);
                    G.FillPath(gloss, Draw.RoundRect(ClientRectangle, 2));

                    botbar = new LinearGradientBrush(new Rectangle(5, Height - 10, Width - 11, 5), Color.FromArgb(44, 45, 49), Color.FromArgb(45, 46, 50), 90);
                    G.FillPath(botbar, Draw.RoundRect(new Rectangle(5, Height - 10, Width - 11, 5), 1));

                    fill = new LinearGradientBrush(new Rectangle(6, Height - 9, Width - 13, 3), Color.FromArgb(174, 195, 30), Color.FromArgb(141, 153, 16), 90);
                    G.FillPath(fill, Draw.RoundRect(new Rectangle(6, Height - 9, Width - 13, 3), 1));
                    o = new Pen(Color.FromArgb(50, 50, 50), 1);
                    G.DrawPath(o, Draw.RoundRect(ClientRectangle, 2));
                    G.DrawPath(Pens.Black, Draw.RoundRect(new Rectangle(1, 1, Width - 3, Height - 3), 2));
                    break;
                case MouseState.Down:
                    lgb = new LinearGradientBrush(ClientRectangle, Color.FromArgb(66, 67, 70), Color.FromArgb(43, 44, 48), 90);
                    G.FillPath(lgb, Draw.RoundRect(ClientRectangle, 2));
                    gloss = new LinearGradientBrush(new Rectangle(0, 0, Width - 125, 35 / 2), Color.FromArgb(100, Color.FromArgb(26, 26, 26)), Color.FromArgb(1, 255, 255, 255), 90);
                    G.FillPath(gloss, Draw.RoundRect(ClientRectangle, 2));
 ...
 //       private Height = 29;
	...
	protected override void OnMouseDown(System.Windows.Forms.MouseEventArgs e)
        {
            base.OnMouseDown(e);
            if (e.Button == MouseButtons.Left & new Rectangle(0, 0, Width, Height).Contains(e.Location))
            {
                Cap = true;
                MouseP = e.Location;
            }
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            switch (State)
            {
                ...
                case MouseState.Over:
                    if (X > 0 && X < 20)
                    {
                        mlgb = new LinearGradientBrush(MinBtn, Color.FromArgb(100, 66, 67, 70), Color.FromArgb(100, 43, 44, 48), 90);
                        G.FillPath(mlgb, Draw.RoundRect(MinBtn, 4));
                        G.DrawPath(new Pen(Color.FromArgb(21, 21, 21), 1), Draw.RoundRect(MinBtn, 4));
                        mf = new Font("Marlett", 9);
                        mfb = new SolidBrush(Color.FromArgb(174, 195, 30));
                        G.DrawString("0", mf, mfb, 4, 4);

                        lgb = new LinearGradientBrush(MaxBtn, Color.FromArgb(66, 67, 70), Color.FromArgb(43, 44, 48), 90);
                        G.FillPath(lgb, Draw.RoundRect(MaxBtn, 4));
                        G.DrawPath(new Pen(Color.FromArgb(21, 21, 21), 1), Draw.RoundRect(MaxBtn, 4));
                        f = new Font("Marlett", 9);
                        fb = new SolidBrush(Color.FromArgb(174, 195, 30));
                        G.DrawString("r", f, fb, 28, 4);

                    }
                    else if (X > 25 && X < 45)
                    {
                        mlgb = new LinearGradientBrush(MinBtn, Color.FromArgb(66, 67, 70), Color.FromArgb(43, 44, 48), 90);
                        G.FillPath(mlgb, Draw.RoundRect(MinBtn, 4));
                        G.DrawPath(new Pen(Color.FromArgb(21, 21, 21), 1), Draw.RoundRect(MinBtn, 4));
                        mf = new Font("Marlett", 9);
                        mfb = new SolidBrush(Color.FromArgb(174, 195, 30));
                        ...
                        lgb = new LinearGradientBrush(MaxBtn, Color.FromArgb(100, 66, 67, 70), Color.FromArgb(100, 43, 44, 48), 90);
                        G.FillPath(lgb, Draw.RoundRect(MaxBtn, 4));
                        G.DrawPath(new Pen(Color.FromArgb(21, 21, 21), 1), Draw.RoundRect(MaxBtn, 4));
                        f = new Font("Marlett", 9);
                        fb = new SolidBrush(Color.FromArgb(174, 195, 30));
