...
namespace CS_ClassLibraryTester
{
    ...
    class SugarTheme : ThemeContainer154
    {
    ...
    class SugarButton : ThemeControl154
    {
        Color Buttoncolor;
        Brush Textcolor;
        ...
        protected override void PaintHook()
        {
            ...
            switch (State)
            {
                ...
                case MouseState.Over:
                    ...
                    HB = new HatchBrush(HatchStyle.DarkDownwardDiagonal, Color.FromArgb(30, Color.White), Color.Transparent);
    ...
    class SugarProgressbar : ThemeControl154
    {
        ...
        protected override void PaintHook()
        {
            ...
            cblend2.Positions = new []{0,(float)0.5,1 };
    ...
    class SugarRadiobutton : ThemeControl154
    {
        private int X;
    ...
    [DefaultEvent("CheckedChanged")]
    class SugarCheckbox : ThemeControl154
    {
        private bool _Checked;
        ...
        public SugarCheckbox()
        {
            this.Size = new Size(16, 50);
        }
    }

    class SugarTabControl : TabControl
    {
        ...
        protected override void OnMouseClick(System.Windows.Forms.MouseEventArgs e)
        {
            base.OnMouseClick(e);
            int index = 0;
            int height = (int)CreateGraphics().MeasureString("Sasi is awesome", Font).Height + 8;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            G.FillRectangle(Brushes.PowderBlue, 0, 0, Width, (int)CreateGraphics().MeasureString("Sasi is awesome", Font).Height + 8);
            G.FillRectangle(new SolidBrush(Color.FromArgb(190, 210, 217)), 2, (int)CreateGraphics().MeasureString("Sasi is awesome", Font).Height + 7, Width - 2, Height - 2);
            ...
            foreach (TabPage tab in TabPages)
            {
                ...
                {
                    G.FillRectangle(new SolidBrush(Color.Red), totallength, 1, (int)CreateGraphics().MeasureString(tab.Text, Font).Width + 15, (int)CreateGraphics().MeasureString("Sasi is awesome", Font).Height + 10);
                    asdf = new HatchBrush(HatchStyle.DarkDownwardDiagonal, Color.FromArgb(35, Color.Red), Color.FromArgb(0, Color.Blue));
                    G.FillRectangle(new SolidBrush(Color.FromArgb(199, 211, 229)), totallength, 1, (int)CreateGraphics().MeasureString(tab.Text, Font).Width + 15, (int)CreateGraphics().MeasureString("Sasi is awesome", Font).Height + 10);
                    asdf = new HatchBrush(HatchStyle.LightDownwardDiagonal, Color.Blue);
                    G.FillRectangle(asdf, totallength, 1, (int)CreateGraphics().MeasureString(tab.Text, Font).Width + 15, (int)CreateGraphics().MeasureString("Sasi is awesome", Font).Height + 10);
                    G.FillRectangle(new SolidBrush(Color.FromArgb(190, 210, 217)), totallength, 1, (int)CreateGraphics().MeasureString(tab.Text, Font).Width + 15, (int)CreateGraphics().MeasureString("Sasi is awesome", Font).Height + 10);

                    LinearGradientBrush gradient = new LinearGradientBrush(new Point(totallength, 1), new Point(totallength, (int)CreateGraphics().MeasureString("Sasi is awesome", Font).Height + 8), Color.FromArgb(15, Color.Black), Color.Transparent);
                    G.FillRectangle(gradient, totallength, 1, (int)CreateGraphics().MeasureString(tab.Text, Font).Width + 15, (int)CreateGraphics().MeasureString("Sasi is awesome", Font).Height + 5);

                    G.DrawLine(new Pen(Color.FromArgb(190, 210, 217)), totallength, 2, totallength, (int)CreateGraphics().MeasureString("Sasi is awesome", Font).Height + 8);

                    G.DrawLine(new Pen(Color.FromArgb(190, 210, 217)), totallength + (int)CreateGraphics().MeasureString(tab.Text, Font).Width + 15, (int)CreateGraphics().MeasureString("Sasi is awesome", Font).Height + 8, Width - 1, (int)CreateGraphics().MeasureString("Sasi is awesome", Font).Height + 8);
                    G.DrawLine(new Pen(Color.FromArgb(190, 210, 217)), 1, (int)CreateGraphics().MeasureString("Sasi is awesome", Font).Height + 8, totallength, (int)CreateGraphics().MeasureString("Sasi is awesome", Font).Height + 8);
    ...
    class SugarTextBox : ThemeControl154
    {
