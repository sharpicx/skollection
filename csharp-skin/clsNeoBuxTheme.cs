...
namespace CS_ClassLibraryTester
{
    ...
    class clsControlMenu : ThemeControl154
    {
        ...
        protected override void PaintHook()
        {
            ...
            //Draw icons            
            G.DrawString("0", new Font("Marlett", (float)8.25,FontStyle.Regular), Brushes.Black, new Point(5, 5));
            if (FindForm().WindowState != FormWindowState.Maximized)
                G.DrawString("1", new Font("Marlett", (float)8.25, FontStyle.Regular), Brushes.Black, new Point(27, 4));
            else
                G.DrawString("2", new Font("Marlett", (float)8.25, FontStyle.Regular), Brushes.Black, new Point(27, 4));
