...
namespace CS_ClassLibraryTester
{
    ...
    abstract class Theme : ContainerControl
    {
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            Capture = false;
            //DefWndProc(Message.Create(Parent.Handle, 161, Flag, IntPtr.zero));
    ...
    class ReconButton : ThemeControl
    {
        public ReconButton()
        {
    ...
    class ReconGroupBox : ThemeContainerControl
    {
    ...
    class ReconCheckBox : ThemeControl
    {
