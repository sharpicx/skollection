...
namespace CS_ClassLibraryTester
{
    ...
    class OriginTheme : ThemeContainer154
    {
    ...
    class OriginButton : ThemeControl154
    {
    ...
    class OriginGroupBox : ThemeContainer154
    {
    ...
    class SecondOriginButton : ThemeControl154
    {
        ...
        protected override void PaintHook()
        {
            ...
            switch (State)
            {
                case MouseState.None:
                    ...
                    break;
                case MouseState.Over:
                    LGB = new LinearGradientBrush(new Rectangle(0, 0, Width - 1, Height - 1), ButtonColorTop, ButtonColorBottom, 90f);
                    G.FillRectangle(LGB, new Rectangle(0, 0, Width - 1, Height - 1));
                    G.FillRectangle(new SolidBrush(Color.FromArgb(50, Color.White)), new Rectangle(0, 0, Width - 1, Height - 1));
                    G.DrawRectangle(Border, new Rectangle(0, 0, Width - 1, Height - 1));
                    DrawText(TextColor, HorizontalAlignment.Center, 0, 0);
    ...
    class OriginRadioButton : ThemeControl154
    {
    ...
    [DefaultEvent("CheckedChanged")]
    class OriginCheckBox : ThemeControl154
    {
